...
export async function effectiveRole(session: Session, tripId: string): Promise<Role | null> {
...
export async function tripIdOf(kind: ResourceKind, id: string): Promise<string | null> {
  switch (kind) {
